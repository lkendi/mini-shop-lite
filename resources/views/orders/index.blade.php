...
<div class="bg-gray-50 dark:bg-gray-900">
    <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-8">
            <h1 class="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900 dark:text-white">My Orders</h1>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden">
            @if($orders->isEmpty())
                <div class="p-6 text-center text-gray-500 dark:text-gray-400">
                    ...
                    <a href="{{ route('products.index') }}" class="mt-4 inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                        Start Shopping
                    </a>
                </div>
            @else
                        ...
                        @foreach($orders as $order)
                            <li class="p-4 sm:p-6">
                                ...
                                <div class="mt-4 text-right">
                                    <a href="{{ route('orders.show', $order) }}" class="text-sm font-medium text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">View Details &rarr;</a>
                                </div>
                            </li>
                        @endforeach
                    </ul>
