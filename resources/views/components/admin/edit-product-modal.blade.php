    ...
    <form method="post" action="" class="p-6" id="edit-product-form">
        ...
        <div class="mt-6 space-y-4">
            <div>
                ...
                <x-text-input id="edit_name" name="name" type="text" class="mt-1 block w-full" required autofocus />
                <x-input-error class="mt-2" :messages="$errors->get('name')" />
            </div>

            <div>
                <x-input-label for="edit_price" value="Price" />
                <x-text-input id="edit_price" name="price" type="number" step="0.01" class="mt-1 block w-full" required />
                <x-input-error class="mt-2" :messages="$errors->get('price')" />
            </div>

            <div>
                <x-input-label for="edit_stock" value="Stock" />
                <x-text-input id="edit_stock" name="stock" type="number" class="mt-1 block w-full" required />
            ...
            <div>
                ...
                <textarea id="edit_description" name="description" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" rows="3"></textarea>
                <x-input-error class="mt-2" :messages="$errors->get('description')" />
            </div>

            <div>
                <x-input-label for="edit_image_url" value="Image URL" />
                <x-text-input id="edit_image_url" name="image_url" type="text" class="mt-1 block w-full" />
